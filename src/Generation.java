public class Generation {
    ...
    public Generation(int minTableSize, int maxTableSize, int maxTableNum, int groupNo, int genSize, GeneticAlgorithm genAlg) {
    ...
    public Generation generateNewGen(){
        ...
        if(newGen.chromosomes.length != genSize){
            System.out.println("Warning, expected " + genSize + " but only generated " + newGen.chromosomes.length + " chromosomes");
        }
